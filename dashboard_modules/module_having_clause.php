...
$sql = "SELECT 
        ...
        HAVING device_count >= 2
           AND error_devices > 0
        ORDER BY device_count DESC, error_devices DESC
        LIMIT 10";
...
return [
    ...
    'description' => 'Users with 2+ Devices and Errors - Uses HAVING to filter aggregated results (vs WHERE for row filtering)',
    'sql' => $sql,
    'data' => $data,
    'icon' => 'fa-filter'
];